...
### 服务状态
- **远程服务**: `http://76.121.3.151:32970`
- **API文档**: `http://76.121.3.151:32970/docs`
- **已加载模型**: 
...
```javascript
// 远程服务器 (推荐，已配置好)
const SPEACHES_BASE_URL = 'http://76.121.3.151:32970';
...
```bash
# 测试服务状态
curl http://76.121.3.151:32970/health

# 查看可用模型
curl http://76.121.3.151:32970/v1/models

# 查看 API 文档
open http://76.121.3.151:32970/docs
```
