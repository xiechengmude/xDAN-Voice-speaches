...
| 功能 | 方法 | 端点 | 说明 |
|-----|------|------|------|
| **ASR** | POST | `/v1/audio/transcriptions` | 非实时语音转文字 |
| **TTS** | POST | `/v1/audio/speech` | 文字转语音 |
| **实时ASR** | WebSocket | `/v1/audio/transcriptions/realtime` | 实时语音转文字 |
| **模型列表** | GET | `/v1/models` | 获取可用模型 |
| **健康检查** | GET | `/health` | 服务状态检查 |
| **API文档** | GET | `/docs` | Swagger 文档 |

### 服务状态
- **远程服务**: `http://24.124.32.70:40693`
- **API文档**: `http://24.124.32.70:40693/docs`
- **已加载模型**: 
  - ASR: `Systran/faster-distil-whisper-large-v3`
  - TTS: `speaches-ai/Kokoro-82M-v1.0-ONNX` (支持中英文)
...
```javascript
// 远程服务器 (推荐，已配置好)
const SPEACHES_BASE_URL = 'http://24.124.32.70:40693';

// 本地开发
// const SPEACHES_BASE_URL = 'http://localhost:8000';

// 生产环境 (HTTPS)
// const SPEACHES_BASE_URL = 'https://your-api.com';
```

### 快速测试
```bash
# 测试服务状态
curl http://24.124.32.70:40693/health

# 查看可用模型
curl http://24.124.32.70:40693/v1/models

# 查看 API 文档
open http://24.124.32.70:40693/docs
```
